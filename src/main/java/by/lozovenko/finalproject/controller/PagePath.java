...
public class PagePath {
    ...
    public static final String MANAGER_PAGE = "jsp/manager/managers_laboratory_page.jsp";
    ...
    public static final String EDIT_PROFILE_PAGE = "jsp/common/edit_profile.jsp";
