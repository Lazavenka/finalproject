...
import static by.lozovenko.finalproject.mapper.impl.EquipmentTypeMapper.EQUIPMENT_TYPE_ID;
import static by.lozovenko.finalproject.mapper.impl.LaboratoryMapper.LABORATORY_ID;
        ...
        try {
            ...
            switch (currentUserRole) {
                ...
                case ASSISTANT -> {
                    ...
                    assistant.setEquipmentTypeId(resultSet.getLong(EQUIPMENT_TYPE_ID));
                ...
                case MANAGER -> {
                    ...
                    manager.setDepartmentId(resultSet.getLong(DEPARTMENT_ID));
                    manager.setLaboratoryId(resultSet.getLong(LABORATORY_ID));
