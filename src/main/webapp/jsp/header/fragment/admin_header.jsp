...
<fmt:message var="add_department" key="admin.add_department"/>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <li><a class="dropdown-item" href="${abs}/controller?command=go_add_new_department_page_command">${add_department}</a></li>
