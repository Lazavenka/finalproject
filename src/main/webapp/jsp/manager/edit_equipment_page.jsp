        ...
        <div class="col-sm-10">
            <div class="collapse" id="editEquipment">
                <form method="post" action="${abs}/controller" class="needs-validation" novalidate>
                    <input type="hidden" value="command" name="update_equipment_command">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="validationResearchTime"
                               class="col-sm-2 col-form-label">${average_research_time}</label>
                        <div class="col-sm-10">
                            <input type="text" name="average_research_time" class="form-control"
                                   ...
                                   id="validationResearchTime" required
